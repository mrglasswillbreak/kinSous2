...
export function SkeletonBountyCard() {
  return (
    <div className="bg-white rounded-3xl shadow-card p-4 space-y-3 border border-gray-100">
...
export function SkeletonHelperCard() {
  return (
    <div className="bg-white rounded-3xl shadow-card p-4 text-center w-44 flex-shrink-0">
