...
export default function MessagesShell({ conversationId }: MessagesShellProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-4">
      <div className="flex flex-col lg:flex-row gap-4 h-[calc(100dvh-160px)] lg:h-[calc(100dvh-140px)]">
        <div
          className={`lg:w-[360px] w-full ${showListOnMobile ? "" : "hidden lg:block"}`}
        >
        ...
        <div
          className={`flex-1 ${conversationId ? "block" : "hidden lg:flex"}`}
        >
          {conversationId ? (
