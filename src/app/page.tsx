import WorkSummary from "@/components/ui/WorkSummary";
...
const features = [
  {
    icon: Flame,
    title: "Bounty Board",
    description: "Post food requests and get bids from local culinary helpers",
    href: "/bounties",
  ...
  },
  {
    ...
    description: "Coordinate directly with your selected helper",
    href: "/bounties",
  ...
  },
  {
    ...
    description: "Clear pricing and payout after confirmed delivery",
    href: "/payment",
  ...
  },
  {
    ...
    description: "Follow each step from shopping to delivery",
    href: "/tracker",
  ...
  },
  {
    icon: MessageCircle,
    title: "Contacts",
    description: "Chat with helpers and manage your orders",
    href: "/contacts",
  ...
  },
  {
    icon: Map,
    title: "Tracker",
    description: "Real-time delivery tracking with live map",
    href: "/tracker",
...
export default async function HomePage() {
  ...
  const ratedHelpers = topHelpers.filter(
    (helper) => helper.helperStats?.averageRating !== undefined,
  );
    ...
    <div className="mx-auto max-w-md pb-24 lg:max-w-5xl lg:pb-10">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-10">
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-bold leading-tight text-charcoal">
                  KinSous
                </h1>
            ...
            <p className="mt-2 leading-relaxed text-muted lg:text-base">
              Connect with local culinary helpers for authentic West African
              food experiences — from Lagos to Atlanta.
            </p>
          ...
          <div className="hidden lg:block">
            <div className="space-y-4 rounded-3xl border border-card-border bg-card p-6 shadow-card">
              {[
                {
                  value: `${recentBounties.length}`,
                  label: "Recent Bounties",
                  emoji: "🍽️",
                },
                {
                  value: `${topHelpers.length}`,
                  label: "Active Helpers",
                  emoji: "👨‍🍳",
                },
                {
                  value:
                    avgHelperRating === "N/A" ? "N/A" : `${avgHelperRating}★`,
                  label: "Avg Helper Rating",
                  emoji: "⭐",
                },
              ].map((stat) => (
                <div
      ...
      <div className="mx-4 mt-4 flex items-center justify-around rounded-3xl border border-card-border bg-card p-4 shadow-card lg:hidden">
        {[
          ...
          {
            value: avgHelperRating === "N/A" ? "N/A" : `${avgHelperRating}★`,
            label: "Avg Rating",
          },
        ].map((stat) => (
      ...
      <div className="mt-6 px-4">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          {features.map((feature) => (
            ...
            >
              <div
                className={`mb-3 flex h-10 w-10 items-center justify-center rounded-2xl ${feature.color}`}
              >
      ...
      <div className="mt-6 px-4 lg:grid lg:grid-cols-2 lg:gap-6">
        ...
        <div className="mt-6 lg:mt-0">
          ...
          <div
            className="flex -mx-4 gap-3 overflow-x-auto px-4 pb-2 lg:hidden"
            ...
            {topHelpers.length === 0 ? (
              ...
              topHelpers.map((helper) => (
                ...
                >
                  ...
                  />
                  <p className="mt-2 truncate text-sm font-bold text-charcoal">
                    {helper.name}
                  </p>
